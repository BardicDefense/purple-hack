...
# 2026\.01.04: New Way to Gain XP

There are now two
[new ways to gain XP](https://hartrpg.com/#experience--leveling):

- **Carousing:** Spend money carousing in exchange for XP at a 1d.=1XP rate.
  Complications may arise!

- **Philanthropy:** Spend money engaging in philanthropy in exchange for XP at a
  2d.=1XP rate. Not as risky as carousing.
...
- Added a provision to allow you to reroll truly garbage characters.

- Specialist mage ability has been broadened to allow for one additional spell
  slot each spell rank, irrespective of spell school.

- It's not new, but it's worth noting the
  [Upgrading Armour and Weapons section](https://hartrpg.com/#upgrading-armour-and-weapons "Upgrading Armour and Weapons section")
  \- it's a good way to spend some of your hard-earned cash, and it's pretty
  underutilized.
...
- Removed Concentration mage feat ‘cause it kinda sucked

- Combined Stillcasting and Spell Silence mage feats into a new Metamagic feat
  to replace the old Metamagic feat ‘cause it kinda sucked

- Updated and simplified Fieldcraft and Lockpicking feats to align with Skill
  system
...
- **Converted to a
  ...
  **Roll a d6, and if you hit your Skill Target you succeed. Skills are either
  ...
  taken multiple times to allow a cumulative lowering of the Skill Target. For
...
- Added a
  ...
  phase after melee, to allow for a strike and _then_ move
...
- Folded Mapping info into a larger section called
  "[Player Roles](https://hartrpg.com/#player-roles "Player Roles")" _(D)_
...
- Clarified that it usually takes two hands to cast any given spell, unless the
  caster has the Dextrous feat.
...
- Added information on [Holy Magic](https://hartrpg.com/#holy-magic) for
  Anointed characters. The holy spell list info is
...
- Shocking Grasp has been buffed and renamed to Shocking Strike, and is now a
  Rank 2 spell
- Change Self is now a Rank 2 spell
...
- Updated Dispel Magic, Disguise, Haste, Hold Person, Spectral Force, and Water
  Breathing

- Renamed Negative Plane Protection to Protection from Undead 'cause that's what
  it does
...
- Updated Elemental Wall and moved it to Rank 4

- Upgraded Fly

- Updated Contact Other Plane and renamed it Oracle
...
- Updated Control Weather, Disintegrate, Invisible Stalker, and Project Image

- Updated Earthquake and renamed it to Earthquake Wave

## Other Stuff

- Google Sheets character sheet has been updated to match.
  [Make a copy here](https://docs.google.com/spreadsheets/d/1wOavveRJ8IEVoqvy33bxn12m20Y_7lqOkc9_KuXwJHo/copy "Make a copy here").

- Did a thorough edit of the whole thing, making minor tweaks and adjustments
  here and there, besides style fixes. Github says I changed 589 lines in that
  commit, so I don't feel like recapping it.
  [See it for yourself](https://github.com/BardicDefense/purple-hack/commit/de1af4877b9b64c86eb2b34842b018314d7b931d)
  if you're dying of curiosity that much.

- Just a final note: I know this is a lot of changes at once, but I'm hoping
  it's not overwhelming and that in practice it'll feel more trickled out at the
  table as things come up. As always, if something just isn't working, I'm
  perfectly happy to revisit and change it until it does.

- _Coming Soon: Carousing & Philanthropy as ways to spend money in exchange for
  more XP._
