...
\section*{1. Character Creation}\label{character-creation}
\markright{\textsc{Character Creation}}
\addcontentsline{toc}{section}{1. Character Creation}
...
\addcontentsline{toc}{subsection}{Feats}
...
\item
  \textbf{Brawler}: If a melee opponent is no more than one size
...
\addcontentsline{toc}{section}{2. Armour, Weapons, and Equipment}
\section*{2. Armour, Weapons, and
Equipment}\label{armour-weapons-and-equipment}
\markright{\textsc{Armour, Weapons, and Equipment}}
...
\addcontentsline{toc}{subsection}{Armour \& Weapons}
...
Heavy armour (L+ = 3 slot) and Large Shields require minimum 9 Str to equip. A Shield also provides a save bonus vs non-gaseous breath weapons equal to its AC bonus.
...
\section*{3. Checks \& Saves}\label{checks-saves}
\markright{\textsc{Checks \& Saves}}
\addcontentsline{toc}{section}{3. Checks \& Saves}
...
\section*{4. Combat}\label{combat}
\markright{\textsc{Combat}}
\addcontentsline{toc}{section}{4. Combat}
...
\addcontentsline{toc}{subsection}{Attacking}
...
\addcontentsline{toc}{subsection}{Combat Phases}
...
\section*{5. General Adventuring}\label{general-adventuring}
\markright{\textsc{General Adventuring}}
\addcontentsline{toc}{section}{5. General Adventuring}

\subsection*{Climbing}\label{climbing}
\addcontentsline{toc}{subsection}{Climbing}
...
\addcontentsline{toc}{subsection}{Doors}
...
\addcontentsline{toc}{subsection}{Dungeon Random Encounters}
...
\addcontentsline{toc}{subsection}{Equipment Wear \& Tear}
...
\addcontentsline{toc}{subsection}{Experience \& Leveling}
...
\tightlist
\item
  \textbf{Recovering treasure}: 1f.
  recovered = 1XP (so 4XP per 1d. recovered).
\item
  \textbf{Killing monsters}.
\item
  Performing \textbf{Feats of Exploration}: 
  ...
  \end{itemize}
\item
	\textbf{Carousing}: Spend 1d6 x (5\% of Total XP Needed by the character to advance to the next level) silver pence. Gain 1 XP per 1d. spent. Roll a Constitution check. On a failure, a complication occurs (the referee has a table for an additional roll - they're usually not good). If you spend more money than you have, you are in debt to an NPC.
\newpage
\item
	\textbf{Philanthropy}: Spend at least the minimum expenditure needed for a settlement in philanthropy and charity. Gain 1 XP per 2d. spent.
	...
	If the amount spent is more than double the minimum expenditure listed for a given settlement size, there is a chance that the populace either resents or appreciates the PC’s generosity. Roll on the table below.
	
	\begin{table}[H]
		\centering
		\begin{tabular}{p{.25in}p{5in}}
			\toprule
				1d6 & Result\\
			\midrule
	...
	\end{table}
\item
	\textbf{Harvesting Monster Parts}: Parts of some monsters are alchemical and magical reagents, sought by sages and enchanters the world over to a greater or lesser degree, depending on the creature in question. After defeating a monster, the party can make an Arcana check to identify and harvest useful monster parts. On a success, roll 1d6 to determine the number of slots of parts harvestable from the monster. The roll is capped by the monster's Level (i.e. a Level 4 monster will not provide more than 4 slots of parts). For each level a monster has above Level 6, the minimum number of slots of parts goes up by one, up to the die cap (i.e. a Level 11 monster will always yield 6 slots of parts). Each slot of parts is worth silver pence (d.) equal to 2\% of the XP value of the monster.

\textbf{Example 1:} The party kills a Level 4 gargoyle worth 75XP, succeeds on its
Arcana check, and rolls a 5 on their 1d6 harvesting roll. The cap is 4, so
they harvest 4 slots of monster parts worth 1d. 2f. (and 6XP) each, a 32\% boost.

\textbf{Example 2:} The party brings down a Level 10 red dragon worth 2300XP and succeeds
...
Feats of Exploration is divided equally among player characters only. Experience gained from carousing and philanthropy applies only to the character who engaged in the activity.
...
\addcontentsline{toc}{subsection}{Falling}
...
\addcontentsline{toc}{subsection}{Fatigue}
...
\addcontentsline{toc}{subsection}{Healing}
...
\addcontentsline{toc}{subsection}{Item Saving Throws}
...
\addcontentsline{toc}{subsection}{Jumping}
...
\addcontentsline{toc}{subsection}{Light \& Vision}
...
\addcontentsline{toc}{subsection}{Lockpicking}
...
\addcontentsline{toc}{subsection}{Moving Silently}
...
\addcontentsline{toc}{subsection}{Perception Checks}
...
\addcontentsline{toc}{subsection}{Player Roles}
...
\addcontentsline{toc}{subsection}{Retainers}
...
\addcontentsline{toc}{subsection}{Sailing}
...
\textbf{Time Unit}: Each turn of pursuit, evasion, or combat takes 5
minutes. This is a ship turn.
...
contested 1d6 at the start of every three turns to determine who has the
favorable wind.
...
\addcontentsline{toc}{subsection}{Speculative Trade}
...
\addcontentsline{toc}{subsection}{Strongholds \& Domains}
...
\addcontentsline{toc}{subsection}{Suffocation}
...
\addcontentsline{toc}{subsection}{Swimming}
...
\addcontentsline{toc}{subsection}{Trap Detection}
...
\section*{6. Magic \& Spells}\label{magic-spells}
\markright{\textsc{Magic \& Spells}}
\addcontentsline{toc}{section}{6. Magic \& Spells}

See full \hyperref[arcane-spells]{arcane spell list here}, and the full
\hyperref[holy-spells]{holy spell list here}.

\subsection*{Arcane Spell Slot Progression
	Table}\label{arcane-spell-slot-progression-table}
	\addcontentsline{toc}{subsection}{Arcane Spell Slot Progression}
...
\addcontentsline{toc}{subsection}{Holy Spell Slot Progression}
...
\addcontentsline{toc}{subsection}{Casting \& Preparing}
...
\addcontentsline{toc}{subsection}{Gaining New Spells}
...
\addcontentsline{toc}{subsection}{Holy Magic}
...
\addcontentsline{toc}{subsection}{Lost Spellbooks}
...
\addcontentsline{toc}{subsection}{Magic Item Crafting}
...
\addcontentsline{toc}{subsection}{NPC Spellcasting}
...
\addcontentsline{toc}{subsection}{Potion Creation}
...
\addcontentsline{toc}{subsection}{The Schools of Magic}
...
\addcontentsline{toc}{subsection}{Scrolls}
...
\section*{7. Upgrading Armour and
Weapons}\label{upgrading-armour-and-weapons}
\markright{\textsc{Upgrading Armour and Weapons}}
\addcontentsline{toc}{section}{7. Upgrading Armour and Weapons}

\subsection*{Upgrading Basics}\label{upgrading-basics}
\addcontentsline{toc}{subsection}{Upgrading Basics}
...
\addcontentsline{toc}{subsection}{Upgrading Armour}
...
\addcontentsline{toc}{subsection}{Upgrading Weapons}
...
\addcontentsline{toc}{subsection}{Armour Upgrades}
...
\addcontentsline{toc}{subsection}{Weapon Upgrades}
...
\section*{8. Wilderness Exploration}\label{wilderness-exploration}
\markright{\textsc{Wilderness Exploration}}
\addcontentsline{toc}{section}{8. Wilderness Exploration}
...
\addcontentsline{toc}{subsection}{Entering a Hex}
...
\addcontentsline{toc}{subsection}{Finding Food in the Wild}
...
\subsection*{Camping in the Wild}\label{camping-in-the-wild}
\addcontentsline{toc}{subsection}{Camping in the Wild}
...
\addcontentsline{toc}{subsection}{Weather}
...
\addcontentsline{toc}{subsection}{Wilderness Random Encounters}
...
\section*{9. Hirelings}\label{hirelings}
\markright{\textsc{Hirelings}}
\addcontentsline{toc}{section}{9. Hirelings}

\subsection*{Standard Hirelings}\label{standard-hirelings}
\addcontentsline{toc}{subsection}{Standard Hirelings}
...
\addcontentsline{toc}{subsection}{Mercenaries/Men-at-Arms}
...
\addcontentsline{toc}{subsection}{Expert Hirelings/Specialists}
...
\section*{10. Arcane Spells}\label{arcane-spells}
\markright{\textsc{Arcane Spells}}
\addcontentsline{toc}{section}{10. Arcane Spells}
...
\section*{11. Holy Spells}\label{holy-spells}
\markright{\textsc{Holy Spells}}
\addcontentsline{toc}{section}{11. Holy Spells}
